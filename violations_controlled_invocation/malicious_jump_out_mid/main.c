...
uint16_t ucc1min __attribute__((section (".ucc1min"))) = 0xE206;
uint16_t ucc1max __attribute__((section (".ucc1max"))) = 0xE268;
uint16_t ucc2min __attribute__((section (".ucc2min"))) = 0xE26A;
uint16_t ucc2max __attribute__((section (".ucc2max"))) = 0xE2D8;
...
int main(void)
{
        ...
        *wdt = WDTPW | WDTHOLD;
         ...
         // input with a buffer overflow. Jumps to an arbitrary location outside region 1
         char input[11] = {'A', 'A', 'A', 'A', 'A', 'A', 'B', 'B', 0xCE, 0xE0, '\0'}; 
