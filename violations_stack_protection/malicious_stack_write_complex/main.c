...
uint16_t ucc1max __attribute__((section (".ucc1max"))) = 0xE330;
uint16_t ucc2min __attribute__((section (".ucc2min"))) = 0xE332;
uint16_t ucc2max __attribute__((section (".ucc2max"))) = 0xE3A0;
...
int main(void)
{
        ...
        *wdt = WDTPW | WDTHOLD;
         ...
         // Purposefully overly large input to violate the stack protection
